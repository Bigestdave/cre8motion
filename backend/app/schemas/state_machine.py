...
VALID_TRANSITIONS: Dict[ProductionStage, Set[ProductionStage]] = {
    ...
    ProductionStage.PLAN_VALIDATION: {ProductionStage.REFERENCE_RESOLUTION, ProductionStage.KEYFRAME_GENERATION, ProductionStage.PLANNING, ProductionStage.FAILED},
    ProductionStage.REFERENCE_RESOLUTION: {ProductionStage.REFERENCE_GENERATION, ProductionStage.KEYFRAME_GENERATION, ProductionStage.SHOT_PLANNING, ProductionStage.FAILED},
    ProductionStage.REFERENCE_GENERATION: {ProductionStage.REFERENCE_QC, ProductionStage.FAILED},
    ProductionStage.REFERENCE_QC: {ProductionStage.KEYFRAME_GENERATION, ProductionStage.SHOT_PLANNING, ProductionStage.REFERENCE_GENERATION, ProductionStage.FAILED},
    ProductionStage.SHOT_PLANNING: {ProductionStage.KEYFRAME_GENERATION, ProductionStage.STORYBOARD_GENERATION, ProductionStage.FAILED, ProductionStage.PAUSED},
    ProductionStage.STORYBOARD_GENERATION: {ProductionStage.KEYFRAME_GENERATION, ProductionStage.STORYBOARD_QC, ProductionStage.FAILED, ProductionStage.PAUSED},
    ...
    ProductionStage.NEEDS_ATTENTION: {ProductionStage.KEYFRAME_GENERATION, ProductionStage.VIDEO_GENERATION, ProductionStage.FAILED, ProductionStage.PAUSED, ProductionStage.CANCELLED},
