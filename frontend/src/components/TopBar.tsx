    ...
    <header className="flex h-[70px] shrink-0 items-center justify-between border-b border-line-soft bg-app px-6">
      ...
      <div className="flex items-center gap-6">
        ...
        {showContinue && (
          <Link
            to={continueTo}
             className="flex h-[36.5px] items-center gap-2 rounded-md border border-accent px-[17px] text-[15px] font-medium text-accent transition-colors hover:bg-accent hover:text-white"
          >
            Continue ↗
          </Link>
        )}
