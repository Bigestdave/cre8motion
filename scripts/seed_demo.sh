...
for ep in \
  ...
  '{"title": "The Moon Necklace", "idea": "Lumi finds a moon-shaped necklace under the kitchen table. When she offers it to the grandparent, the reflection of the visitor appears in the window. Someone has been inside the house."}'; do
